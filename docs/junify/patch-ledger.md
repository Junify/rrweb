...
| `LIFE-REP-001` | implemented; upstream-candidate | Destroy must release timers, subscriptions, pending callbacks, iframe maps, and roots (`junify.lifecycle.replayer-destroy`)                                                            | PostHog PR 92 / `f3bdcfe`; PRs 121-123 rejected as cross-origin scope                                                                                                                                     | Task 8 `G-REPLAYER-LIFECYCLE`; 50-cycle ownership/silence census and cleanup-throw sink                                                           | absent/incomplete in 2.1.1; implemented by `970cc0ce` beyond PR 92's partial teardown                                                              | upstream stable passes the complete 50-cycle lifecycle gate without Junify adaptation                             |
