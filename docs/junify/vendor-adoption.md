...
| P0 | password type transitions: rrweb PRs 1170/1184, `d2582e9a81197130cd93bc1dd778e16fddfb0be3` and `aa79db7568578ea3a413292450cd64f07481e5dd` | yes | `adopt` | dynamic text/password type transitions remain masked in both mutation orders | `G-PRIVACY` | no duplicate patch; keep persisted sentinel even after adoption |
| P0 | textarea serialization/masking corrections: rrweb PRs 1351/1599, `a2be77b82826c4be0e7f3c7c9f7ee50476d5f6f8` and `9cd28b703ec08a77dc6b790dbffb20dfb8e9a513` | yes | `adopt` | initial and mutated textarea secrets remain absent | `G-PRIVACY` | no duplicate patch; keep persisted sentinel even after adoption |
...
| P0 | always-sensitive autocomplete handling: Sentry PR 166, `432fe1f9` | no | `adapt` | values associated with sensitive autocomplete tokens are absent from persisted payloads | `G-PRIVACY`; ledger `PRIV-003` | delete when upstream stable passes the same autocomplete sentinel matrix |
